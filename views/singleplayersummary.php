...
<img class="player-image" style="float: left;" src="/fyp-dev-build/images/player-image.PNG">
<h2 class="player-description" style="float: left;">(INSERT SELECTED PLAYER NAME) | (INSERT LOCATION)</h2>
...
<div class="gav" style="clear: both;">
